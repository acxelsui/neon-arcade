...
const required = [
  'index.html', 'music.js', 'music-branding.js', 'music-catalog.json', 'music-links.js', 'music.css', 'chat.js', 'chat.css', 'appearance.js', 'library-tools.js', 'proxy-feedback.js', 'bootstrap-init.js', 'game-runner.html', 'game-runner.js', 'game-transport.js', 'sw.js', 'scram/scramjet.js',
